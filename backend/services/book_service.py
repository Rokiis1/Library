...
async def create_book(book: Book):
    ...
    try:
        ...
        result = await conn.fetchrow(query, book.title, book.author, book.year, book.image)
        book_id = result["id"]
...
async def update_all_book(book_id: int, book: Book):
    ...
    try:
        ...
        print(f"query: {query}, title: {book.title}, author: {book.author}, year: {book.year}, image: {book.image}, book_id: {book_id}")
        await conn.execute(query, book.title, book.author, book.year, book.image, book_id)
